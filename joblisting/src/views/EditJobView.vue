...
const handleSubmit = async () => {
  ...
  try {
    ...
    router.push(`/jobs/${response.data.id}`); // it will save into the jobs list we have
  } catch (error) {
...
onMounted(async()=>{
    try {
        ...
        form.name = job.name;
        form.descriptions = job.descriptions;
        form.contactEmail = job.contactEmail;
        form.contactPhone = job.contactPhone;
    } catch (error) {
        console.error('Error fetching job', error);
    }
    finally{
